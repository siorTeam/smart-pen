...
n=len(linPosHP)
ax.plot(linPosHP[0:n//4,0], linPosHP[0:n//4,1], linPosHP[0:n//4,2], alpha = 1.0)
ax.plot(linPosHP[n//4:n//2,0], linPosHP[n//4:n//2,1], linPosHP[n//4:n//2,2], alpha = 0.0)
ax.plot(linPosHP[n//2:n*3//4,0], linPosHP[n//2:n*3//4,1], linPosHP[n//2:n*3//4,2], alpha = 1.0)
ax.plot(linPosHP[n*3//4:,0], linPosHP[n*3//4:,1], linPosHP[n*3//4:,2], alpha = 0.0)
